...
- `cargo test -p ohm-ecdsa` — runs 30 unit tests (inline `#[cfg(test)]`
  ...
  time of writing.
- `cargo test -p ohm-ecdsa-node` — 91 tests: 3 M1 tests in
